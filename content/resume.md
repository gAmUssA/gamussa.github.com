...
layout: "single"
url: "/resume/"
summary: "Viktor Gamov — Principal Developer Advocate, Java Champion, Author"
ShowToc: false
...
<style>
.resume-header { text-align: center; margin-bottom: 2.5rem; }
.resume-header h2 { font-family: var(--serif); font-size: 1rem; font-weight: 400; color: var(--secondary); margin: 0.3em 0 1rem; font-style: italic; }
.resume-badges { display: flex; flex-wrap: wrap; justify-content: center; gap: 0.5rem; margin-bottom: 1.2rem; }
.resume-badges span {
...
.resume-links { font-family: var(--sans); font-size: 0.85rem; color: var(--secondary); }
.resume-links a { color: var(--accent-secondary); text-decoration: none; }
.resume-links a:hover { text-decoration: underline; }

.resume-section { margin-bottom: 2.5rem; }
.resume-section h2 { font-family: var(--serif); font-size: 1.4rem; font-weight: 600; color: var(--primary); border-bottom: 2px solid var(--border); padding-bottom: 0.3em; margin-bottom: 1.2rem; }

.role { margin-bottom: 1.8rem; }
.role-header { display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap; gap: 0.25rem; margin-bottom: 0.2rem; }
.role-title { font-family: var(--serif); font-size: 1.1rem; font-weight: 600; color: var(--primary); margin: 0; }
.role-date { font-family: var(--sans); font-size: 0.82rem; color: var(--secondary); white-space: nowrap; }
.role-company { font-family: var(--sans); font-size: 0.95rem; color: var(--accent-secondary); font-weight: 500; margin: 0 0 0.5rem; }
.role ul { margin: 0; padding-left: 1.2em; }
.role li { font-size: 0.95rem; line-height: 1.6; color: var(--secondary); margin-bottom: 0.3em; }

.talk-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.3rem 2rem; font-size: 0.9rem; }
.talk-grid .talk-name { color: var(--primary); }
.talk-grid .talk-venue { color: var(--secondary); text-align: right; }
@media (max-width: 640px) { .talk-grid { grid-template-columns: 1fr; } .talk-grid .talk-venue { text-align: left; } }
...
<div class="resume-badges">
  ...
  <span>Testcontainers Champion</span>
...
<div class="resume-links">
  <a href="https://github.com/gamussa">GitHub</a> · 
  <a href="https://linkedin.com/in/vikgamov">LinkedIn</a> · 
...
<div class="pub">
  <span class="pub-title">Kafka in Action</span><br>
  <span class="pub-meta">Manning Publications, 2022 · Co-authored with Dylan Scott and Dave Klein</span><br>
  <span class="pub-meta"><a href="http://kafkainaction.org">kafkainaction.org</a> · <a href="https://www.amazon.com/Kafka-Action-Dylan-Scott/dp/161729523X/">Amazon</a></span>
</div>

<div class="pub">
  <span class="pub-title">Enterprise Web Development: Building HTML5 Applications from Desktop to Mobile</span><br>
  <span class="pub-meta">O'Reilly Media, 2014 · Co-authored with Yakov Fain, Victor Rasputnis, Anatole Tartakovsky</span><br>
  <span class="pub-meta"><a href="https://www.oreilly.com/library/view/enterprise-web-development/9781449357023/">O'Reilly</a></span>
</div>
