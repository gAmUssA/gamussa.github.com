...
// Source: clipboard-flow.d2 — re-render with `d2 clipboard-flow.d2 clipboard-flow.svg`
.Clipboard tear-down: capture timing decides everything
image::clipboard-flow.svg[Clipboard tear-down sequence: naive (5 steps ending in an empty pane) vs fixed (capture-pane wedged in before teardown)]
...
****
**About the author** — Viktor Gamov is a Principal Developer Advocate at Confluent, where he spends most of his day in tmux and the rest of it explaining why streaming systems behave the way they do.
