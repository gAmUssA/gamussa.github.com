...
In this starter, you should enable "Spring for Apache Kafka" and "Spring Web Starter."

_Figure 1. Generate a new project with Spring Initializer._ +
...
<2> Avro dependency
<3> Avro SerDes
<3> Confluent Maven repository
<4> Source directory where you put your Avro files and store generated Java POJOs
...
In the examples directory, run `./mvnw clean package` to compile and produce a runnable JAR.
